...
def view_graph():
    ...
    graph_window.configure(bg="Medium Aquamarine")

    # Set heading
    Label(graph_window, text="Expense Chart", font=('Georgia', 20, 'bold')).place(x=230, y=40)

    # Create button
    Button(graph_window, text="Daily Expense Chart", font=('Georgia', 15), width=23, bg="Grey", command=daily_expense).place(x=25, y=120)
    Button(graph_window, text="Monthly Expense Chart", font=('Georgia', 15), width=23, bg="Grey", command=monthly_expense).place(x=25, y=200)
    Button(graph_window, text="Category Expense Chart", font=('Georgia', 15), width=23, bg="Grey", command=expense_categories).place(x=360, y=120)
    Button(graph_window, text="Expense Analysis", font=('Georgia', 15), width=23, bg="Grey", command=categories_percentage).place(x=360, y=200)
...
def view_report():
    ...
    report_window.configure(bg="Medium Aquamarine")

    # Set heading
    Label(report_window, text="Report", font=('Georgia', 20, 'bold')).place(x=300, y=40)

    # Create button
    Button(report_window, text="Monthly Budget", font=('Georgia', 15), width=23, bg="Grey", command=monthly_budget_report).place(x=25, y=120)
    Button(report_window, text="Remain Budget", font=('Georgia', 15), width=23, bg="Grey", command=remain_budget).place(x=25, y=200)
    Button(report_window, text="Remain Trend", font=('Georgia', 15), width=23, bg="Grey", command=monthly_trend).place(x=360, y=120)
    Button(report_window, text="Budget Report", font=('Georgia', 15), width=23, bg="Grey", command=remain_report).place(x=360, y=200)
